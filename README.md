...
| `xen_vman_debootstrap_packages`          | list of strings                |    `[systemd,systemd-sysv,udev,openssh-server,sudo,python]`    | Packages to install into a newly installed VM using debootstrap                                                                       |
