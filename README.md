...
| `xen_vman_debootstrap_packages`          | list of strings                | `[systemd,systemd-sysv,udev,openssh-server,sudo,python,iproute2]` | Packages to install into a newly installed VM using debootstrap                                                                       |
